...
type Position = { top?: number; right?: number; left?: number; bottom?: number };
...
const ScrollSectionCard = ({
  ...
  position?: Position;
  direction: 'top' | 'right' | 'bottom' | 'left';
  scrollLimit: { start: number; end: number };
  ...
  const style: React.CSSProperties = { [direction]: animatedValue };
